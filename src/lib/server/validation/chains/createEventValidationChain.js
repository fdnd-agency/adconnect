...
/**
 * Builds the validation chain for an event.
 *
 ...
 */
export function createEventValidationChain({ mode = 'create', message }) {
	...
	const lastHandler = validator
		...
		.setNext(new RequiredFieldHandler('time_duration', 'Vul een tijdsduur in.'))
