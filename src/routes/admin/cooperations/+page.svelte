<script>
	...
	const cooperations = $derived(data.cooperations ? [...data.cooperations.values()] : [])
...
<svelte:head>
	<title>Samenwerkingen | ADConnect Admin</title>
</svelte:head>
...
<AdminToolbar
	...
	labels={{ all: 'Alle samenwerkingen', draft: 'Concept', published: 'Gepubliceerd' }}
/>
